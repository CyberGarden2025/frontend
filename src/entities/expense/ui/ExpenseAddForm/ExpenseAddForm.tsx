    ...
    if (type === 0) {
        return (
            <form className={cls.form}>
                <input value={data.sum} onChange={(e) => setData((prev) => ({...prev, sum: +e.target.value}))} type="number" className={cls.numberInput} placeholder="Сумма" />
                <div className={cls.inputWrapper}>
                    ...
                    <input
                        ...
                        onChange={(e) => setData((prev) => ({...prev, transactionDate: e.target.value}))}
        ...
        return (
            <form className={cls.form}>
                <input type="number" onChange={(e) => setData((prev) => ({...prev, sum: +e.target.value}))} value={data.sum} className={cls.numberInput} placeholder="Сумма*" />
                <input type="text" onChange={(e) => setData((prev) => ({...prev, category: e.target.value}))} value={data.category} className={cls.numberInput} placeholder="Категория" />
                <div className={cls.inputWrapper}>
                    <div className={cls.iconWrapper}>
                        <CalendarIcon />
                    </div>
